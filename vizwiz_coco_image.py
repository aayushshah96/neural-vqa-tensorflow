...
'''
target_id = 581921                                  # Unique id used to start conversion process from
...
target_dir = os.getcwd() + '/Data/train_2014'       # Directory to move images onto

images_dir = os.getcwd() + '/Data/vizwiz/Images'    # Directory to move images from
